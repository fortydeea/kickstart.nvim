  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      ...
      local function try_attach(buf, language)
        ...
        -- Buffer might no longer be valid once an async install finishes
        ...
        -- Enable treesitter-based indentation where a query exists;
        -- otherwise indentexpr falls back to Vim's built-in indent (this replaces
        -- your old `indent.disable = { 'ruby' }`, since ruby just has no indent query)
      ...
      vim.api.nvim_create_autocmd('FileType', {
        callback = function(args)
          ...
          elseif vim.tbl_contains(available_parsers, language) then
            -- mirrors your old `auto_install = true`
